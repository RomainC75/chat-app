...
func (msgRepo *MessageRepository) CreateMessage(ctx context.Context, arg db.CreateUserParams) (db.Message, error) {
...
// func (userRepo *MessageRepository) FindUserByEmail(ctx context.Context, email string) (db.User, error) {
