...
func NewTestDriverAndConnectUser1() (*TestDriver, *chat_infra.FakeWebSocket) {
...
func (td *TestDriver) CreateNewClient(id int32, email string) *chat_infra.FakeWebSocket {
	newUserSocket := chat_infra.NewFakeWebSocket()
...
func (td *TestDriver) GetNextMessageToWriteUnserialized(socket *chat_infra.FakeWebSocket) messages.MessageOut {
...
func (td *TestDriver) TriggerMessageIn(socket *chat_infra.FakeWebSocket, messageIn messages.MessageIn) {
...
func (td *TestDriver) WaitForNextMessageOut(socket *chat_infra.FakeWebSocket) (int, messages.MessageOut, error) {
	socket.GetWG().Wait()
...
func (td *TestDriver) AddWaitToSelectedSockets(sockets ...*chat_infra.FakeWebSocket) {
